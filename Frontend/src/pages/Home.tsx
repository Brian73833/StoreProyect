...
const Home: React.FC = () => {
  ...
  return (
    <main className="min-h-screen bg-background text-on-background font-body-md">
      ...
      <section className="px-16 py-20 bg-surface-container-low border-b border-slate-300">
        <div className="max-w-7xl mx-auto">
          <p className="font-label-caps text-xs text-primary mb-3 uppercase tracking-widest">
            CLIENT PORTAL
          </p>
          <h2 className="font-headline-xl text-5xl font-bold leading-tight tracking-tight text-on-surface mb-6">
            Bienvenido, {userName}
          </h2>
          <p className="font-body-lg text-xl text-secondary max-w-2xl mb-12 leading-relaxed">
          ...
          <div className="flex flex-wrap gap-6">
            <button
              ...
              className="bg-primary text-on-primary px-12 py-3 font-label-caps text-xs uppercase tracking-widest
                         active:translate-y-0.5 transition-transform"
            >
              Catalog Access
            </button>
            <button
              className="border-2 border-stone-800 text-stone-800 px-12 py-3 font-label-caps text-xs uppercase tracking-widest
      ...
      <section className="px-16 py-20">
        <div className="max-w-7xl mx-auto">
          <h3 className="font-label-caps text-xs text-secondary mb-12 uppercase tracking-widest">
            QUICK NAVIGATION
          </h3>

          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            {/* Large Feature: Catalog */}
            <div className="md:col-span-8 bg-stone-100 border border-slate-300 border-b-[4px] border-b-stone-800 p-12 flex flex-col justify-between min-h-[400px] relative overflow-hidden group">
              <img
              ...
              <div className="relative z-10">
                ...
                <h4 className="font-headline-lg text-3xl font-semibold text-on-surface">
                  Product Catalog
                </h4>
              ...
              <Link
                ...
                className="relative z-10 font-label-caps text-xs text-primary flex items-center gap-2
                           hover:translate-x-2 transition-transform uppercase tracking-widest"
              >
                VIEW COLLECTION{" "}
                <span
            ...
            <div className="md:col-span-4 bg-tertiary-fixed border border-slate-300 border-b-[4px] border-b-tertiary p-12 flex flex-col justify-between">
              <div>
                <span
                ...
                <h4 className="font-headline-md text-2xl font-semibold text-on-tertiary-fixed">
                  Expert Consultation
                </h4>
              ...
              <button
                className="bg-tertiary text-on-tertiary py-3 font-label-caps text-xs uppercase tracking-widest
                           active:translate-y-0.5 transition-transform w-full mt-12"
              >
                Request Call
              </button>
            </div>
            ...
            <div className="md:col-span-4 bg-surface-container-high border border-slate-300 border-b-[4px] border-b-slate-500 p-12 flex flex-col justify-between">
              <div>
                <span
              ...
              <Link
                to="/profile"
                className="font-label-caps text-xs text-secondary mt-12 hover:text-on-surface transition-colors uppercase tracking-widest"
              >
                OPEN PROFILE
              </Link>
            </div>
            ...
            <div className="md:col-span-8 bg-stone-900 text-stone-100 p-12 border-b-[4px] border-b-orange-800">
              <div className="flex flex-col md:flex-row gap-12 items-center">
                <div className="flex-1">
                  <h4 className="font-headline-lg text-3xl font-semibold mb-3">
      ...
      <section className="px-16 py-20 bg-stone-50 border-t-2 border-slate-200">
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-between items-end mb-12">
            <div>
              ...
              <h3 className="font-headline-lg text-3xl font-semibold">
