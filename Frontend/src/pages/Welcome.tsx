  ...
  return (
    <main className="flex-grow bg-background font-body-md text-on-background">
      ...
      <section className="relative w-full h-[751px] overflow-hidden">
        ...
        />
        <div className="absolute inset-0 z-20 flex flex-col justify-center items-start px-8 md:px-16">
          <div className="w-full bg-white/95 p-20 border-l-[12px] border-primary">
            ...
            <p className="font-body-lg text-body-lg text-secondary mb-12 max-w-2xl">
            ...
            <div className="flex gap-6">
              <button 
                ...
                className="bg-primary text-on-primary font-label-caps text-xs uppercase tracking-widest px-12 py-6 hover:bg-primary-container transition-all active:translate-y-0.5 border-b-4 border-stone-900">
                ENTER STORE
              </button>
            </div>
          </div>
      ...
      {/* Material Focus Grid */}
      <section className="py-20 px-16 max-w-[1440px] mx-auto">
        <div className="grid grid-cols-12 gap-6">
          {/* Large Feature */}
          <div className="col-span-12 md:col-span-8 bg-stone-100 border border-slate-300 p-12 flex flex-col justify-between min-h-[400px]">
            <div>
              <span
              ...
              <h3 className="font-headline-lg text-headline-lg text-stone-900 mb-2 uppercase">
                Granular Detail
              </h3>
          ...
          {/* Vertical Feature */}
          <div className="col-span-12 md:col-span-4 bg-stone-900 text-stone-100 border border-slate-700 p-12 flex flex-col justify-center items-center text-center">
            <span
      ...
      <section className="bg-stone-50 py-20 px-16 border-y border-slate-200">
